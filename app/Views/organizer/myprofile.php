    ...
    <div class="profile-container">
        ...
        <div class="profile-card">
            <div class="profile-card-header">
                ...
                <button type="button" id="updateProfileBtn" class="btn-primary" style="float: right; margin-top: -5px;">Edit Profile</button>
            </div>
    ...
    <div id="editProfileModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('organizer/profile/update/' . $user->id) ?>" method="post">
                    <?= csrf_field() ?>
