            ...
            <?php foreach ($registrations as $reg): ?>
                <div class="registration-item">
                    ...
                    <div class="reg-details">
                        ...
                        <p>
                            <strong>Date:</strong> <?= date('d M Y, h:i A', strtotime($reg['event']['start_datetime'])) ?><br>
                            <strong>Registered On:</strong> <?= date('d M Y', strtotime($reg['registration_date'])) ?><br>
                            <strong>Payment:</strong> <?= ucfirst($reg['payment_status']) ?>
                        </p>
                    </div>
                </div>
            <?php endforeach; ?>
